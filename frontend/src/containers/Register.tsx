...
const Register: React.FC = () => {
    ...
    const register = async () => {
        await registerMutation({ username, password, idBytes: idBytes?.name ?? '', state }).unwrap()
            .then((data) => {
    ...
    <div id='login'>
        <div className="box">
            ...
            <div className='field'>
                ...
                <div className='control'>
                    <input className='input' type='file' onChange={(e) => setIdBytes(e.target.files?.[0])} />
                </div>
            </div>
            <div className='field'>
            ...
            <div className='field'>
                <div className='control'>
                    <button className='button is-primary' onClick={register}>Register</button>
                </div>
            </div>
